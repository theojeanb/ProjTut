...
CREATE TABLE `equipement` (
  ...
  CONSTRAINT `FK_B8B4C6F321D9C0A` FOREIGN KEY (`arme_id`) REFERENCES `arme` (`id`),
  CONSTRAINT `FK_B8B4C6F326926994` FOREIGN KEY (`casque_id`) REFERENCES `armure` (`id`),
  CONSTRAINT `FK_B8B4C6F330EF2009` FOREIGN KEY (`plastron_id`) REFERENCES `armure` (`id`),
  CONSTRAINT `FK_B8B4C6F37126B348` FOREIGN KEY (`potion_id`) REFERENCES `potion` (`id`),
  CONSTRAINT `FK_B8B4C6F39FFEB269` FOREIGN KEY (`jambieres_id`) REFERENCES `armure` (`id`),
  CONSTRAINT `FK_B8B4C6F3A49B5F19` FOREIGN KEY (`bottes_id`) REFERENCES `armure` (`id`),
